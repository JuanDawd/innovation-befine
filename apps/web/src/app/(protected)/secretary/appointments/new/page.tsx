/**
 * Secretary — book appointment page (T050)
 */
...
export default async function SecretaryNewAppointmentPage() {
  ...
  return (
    <div className="flex flex-col gap-6 p-6 max-w-lg">
      <div>
        <h1 className="text-2xl font-semibold">{t("bookAppointment")}</h1>
        <p className="text-sm text-muted-foreground">{t("bookAppointmentDescription")}</p>
      </div>
      <BookAppointmentForm redirectPath="/secretary" />
    </div>
  );
}
